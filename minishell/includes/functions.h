...
/*   functions.h                                        :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: danielruiz <danielruiz@student.42.fr>      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/23 11:47:37 by sternero          #+#    #+#             */
/*   Updated: 2024/10/28 21:54:36 by danielruiz       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// estas  funciones que he puesto abajo no estaban en el .h pero he intentado pulsar
// encima con el ctrl para ver a donde llevan y no enlaza a ninguna  función
// no sé si es correcto o es que faltan esas funciones porque al  hacer make
// sigue dando error de esta función y entiendo que será porque no la encuentra...  
...
void	exec_back_pwd(t_minishell *shell);
