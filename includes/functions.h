...
/*   Updated: 2024/11/01 12:24:51 by druiz-ca         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    env_err3();
void 	ft_print_env2(t_minishell *shell);


// export

void 	ft_print_env_err2(t_minishell *shell, int env_err, char *command);
...
void    execute_bin_cmd(char *cmd_path, t_cmd **commands, t_minishell *shell, int i);
